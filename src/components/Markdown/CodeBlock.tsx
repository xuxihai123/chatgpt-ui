...
export const CodeBlock: FC<Props> = ({ language, value, lightMode }) => {
    ...
    return (
        <div className="relative text-[16px] pt-2">
            ...
            <button className="absolute top-[-8px] right-[0px] text-white bg-none py-0.5 px-2 rounded focus:outline-none hover:bg-blue-700 text-xs" onClick={copyToClipboard}>
                {buttonText}
            </button>
        </div>
    );
